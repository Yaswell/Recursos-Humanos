...
namespace GRHm.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Desde,Hasta,Motivo,Comentario")] Permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Desde,Hasta,Motivo,Comentario")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
